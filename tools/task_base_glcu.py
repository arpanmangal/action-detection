"""
Script to train task base_out GLCU separately
"""
...
parser.add_argument('--in_features', type=int, default=1024, help='Size of base_out')
    ...
    def _read_pkl(self):
        ...
        while True:
            try:
                ...
                pkl_data[vid_id] = base_out.mean(axis=0)
            except EOFError:
                break
...
class Trainer:
    ...
    """
    def __init__(self):
        self.net = GLCU(args.in_features, args.num_tasks, half_unit=True).cuda()
